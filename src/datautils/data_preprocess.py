"""
Creates a preprocessed dataset from ShapeNet and R2N2 which contains meshes, images, and sampled point clouds
Adapted from https://github.com/facebookresearch/meshrcnn/blob/master/tools/preprocess_shapenet.py.
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--r2n2_dir",
        default="./data/ShapeNet/ShapeNetRendering",
        help="Path to the Shapenet renderings as provided by R2N2",
    )
    parser.add_argument(
        "--shapenet_dir",
        default="./data/ShapeNet/ShapeNetCore.v1",
        help="Path to the Shapenet Core V1 dataset",
    )
    parser.add_argument(
        "--splits_file",
        default="./data/ShapeNet/ShapeNetRendering/pix2mesh_splits_val05.json",
